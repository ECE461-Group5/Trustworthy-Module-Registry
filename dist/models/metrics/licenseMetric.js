...
export class LicenseMetric extends Metric {
    constructor() {
        super(...arguments);
        // Approved licenses
        this.approvedLicensesIdentifiers = ["MIT", "LGPL", "Apache-1.0", "Apache-1.1"];
        this.approvedLicensesNames = ["MIT", "GNU Lesser General Public License", "Apache License 1.0", "Apache License 1.1"];
        // Clone directory
        this.cloneDir = path.join(process.cwd(), "temp-repo");
    }
    ...
    extractLicenseIdentifier(content) {
